...
# init.d support
PRODUCT_COPY_FILES += \
    vendor/DEMENTED/prebuilt/demented/etc/init.d/01dementedbomb:system/etc/init.d/01dementedbomb \
    vendor/DEMENTED/prebuilt/demented/etc/init.d/02dementedkernel:system/etc/init.d/02dementedkernel \
